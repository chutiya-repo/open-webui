<script lang="ts">
	...
	export let imageUrls = [
		`${ANSWERAI_BASE_URL}/assets/images/adam.jpg`,
		`${ANSWERAI_BASE_URL}/assets/images/galaxy.jpg`,
		`${ANSWERAI_BASE_URL}/assets/images/earth.jpg`,
		`${ANSWERAI_BASE_URL}/assets/images/space.jpg`
	];
