...
from answerai.retrieval.loaders.external_document import ExternalDocumentLoader

from answerai.retrieval.loaders.mistral import MistralLoader
from answerai.retrieval.loaders.datalab_marker import DatalabMarkerLoader
from answerai.retrieval.loaders.mineru import MinerULoader


from answerai.env import GLOBAL_LOG_LEVEL, REQUESTS_VERIFY
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if not api_base_url or api_base_url.strip() == "":
                api_base_url = "https://www.datalab.to/api/v1/marker"  # https://github.com/answerai/answerai/pull/16867#issuecomment-3218424349
