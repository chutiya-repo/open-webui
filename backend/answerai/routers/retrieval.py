...
from answerai.models.files import FileModel, FileUpdateForm, Files
...
from answerai.retrieval.web.ollama import search_ollama_cloud
from answerai.retrieval.web.perplexity_search import search_perplexity_search
...
from answerai.retrieval.web.azure import search_azure
...
from answerai.retrieval.vector.utils import filter_metadata
    ...
    if engine == "ollama_cloud":
        ...
        if (
            ...
            return search_google_pse(
                ...
                request.app.state.config.WEB_SEARCH_RESULT_COUNT,
                request.app.state.config.WEB_SEARCH_DOMAIN_FILTER_LIST,
                referer=request.app.state.config.ANSWERAI_URL,
            )
        else:
            raise Exception(
