    ...
    def test_users(self):
        ...
        with mock_answerai_user(id="1"):
            response = self.fast_api_client.post(
                ...
                json={
                    "name": "user 2 updated",
                    "email": "user2-updated@answerai.in",
