...
`/metrics` endpoint – ANSWERAI does **not** expose it directly.
...
def _build_meter_provider(resource: Resource) -> MeterProvider:
    ...
    views: List[View] = [
        ...
        View(
            instrument_name="answerai.users.total",
        ),
        View(
            instrument_name="answerai.users.active",
        ),
        View(
            instrument_name="answerai.users.active.today",
        ),
    ]
...
def setup_metrics(app: FastAPI, resource: Resource) -> None:
    ...
    meter.create_observable_gauge(
        name="answerai.users.active.today",
