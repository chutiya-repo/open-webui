...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "MyAIPlatform")
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("myaiplatform")}
else:
    try:
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "myaiplatform")
