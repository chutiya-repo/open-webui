...
from myaiplatform.config import CACHE_DIR
from myaiplatform.constants import ERROR_MESSAGES
from myaiplatform.env import ENABLE_FORWARD_USER_INFO_HEADERS, SRC_LOG_LEVELS
from myaiplatform.routers.files import upload_file
from myaiplatform.utils.auth import get_admin_user, get_verified_user
from myaiplatform.utils.images.comfyui import (
    ...
    try:
        if request.app.state.config.IMAGE_GENERATION_ENGINE == "openai":
            ...
            if ENABLE_FORWARD_USER_INFO_HEADERS:
                headers["X-MyAIPlatform-User-Name"] = user.name
                headers["X-MyAIPlatform-User-Id"] = user.id
                headers["X-MyAIPlatform-User-Email"] = user.email
                headers["X-MyAIPlatform-User-Role"] = user.role
