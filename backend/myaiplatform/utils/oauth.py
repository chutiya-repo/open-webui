...
from myaiplatform.models.auths import Auths
from myaiplatform.models.users import Users
from myaiplatform.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from myaiplatform.constants import ERROR_MESSAGES, WEBHOOK_MESSAGES
from myaiplatform.env import (
    WEBUI_NAME,
    WEBUI_AUTH_COOKIE_SAME_SITE,
    WEBUI_AUTH_COOKIE_SECURE,
)
from myaiplatform.utils.misc import parse_duration
from myaiplatform.utils.auth import get_password_hash, create_token
from myaiplatform.utils.webhook import post_webhook

from myaiplatform.env import SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in MyAIPlatform: {[g.name for g in all_available_groups]}"
        )
