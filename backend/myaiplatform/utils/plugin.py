...
from myaiplatform.env import SRC_LOG_LEVELS, PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
from myaiplatform.models.functions import Functions
from myaiplatform.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from myaiplatform.utils",
        "from apps": "from myaiplatform.apps",
        "from main": "from myaiplatform.main",
        "from config": "from myaiplatform.config",
    }
